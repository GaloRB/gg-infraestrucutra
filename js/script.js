...
let añosboton = document.querySelector('.quien');
let añosseccion = document.querySelector('.años');
...
añosboton.addEventListener('click', () => {
    añosseccion.classList.add('agregarMargin');
})

window.addEventListener('scroll', () => {
    añosseccion.classList.remove('agregarMargin');
})
